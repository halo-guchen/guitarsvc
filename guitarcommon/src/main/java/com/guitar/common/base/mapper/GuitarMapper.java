package com.guitar.common.base.mapper;
...
public interface GuitarMapper<T> {
     ...
     * @return
     */
    @DeleteProvider(type = GuitarMapperProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @SelectProvider(type = GuitarMapperProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @InsertProvider(type = GuitarMapperProvider.class, method = "dynamicSQL")
    int insert(T record);
     ...
     * @return
     */
    @UpdateProvider(type = GuitarMapperProvider.class, method = "dynamicSQL")
